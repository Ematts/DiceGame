...
public class field {
	...
	public int diceTotal() {
		...
		System.out.println(four.currentValue);
		System.out.println(six.currentValue);
		System.out.println(eight.currentValue);
		System.out.println(ten.currentValue);
		System.out.println(twelve.currentValue);
		System.out.println(twenty.currentValue);
